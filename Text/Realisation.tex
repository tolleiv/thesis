...
Mit Hilfe von Apache Mahout werden drei Bestandteile der im Systementwurf (Abbildung \ref{fig:system_rough}) gezeigten bzw. in Abschnitt \ref{sec:system_rough} beschriebenen Systemarchitektur realisiert.
